...
const ICON_APP = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300" width="100%" height="100%"><image href="/app-icon.webp" x="0" y="0" width="300" height="300" preserveAspectRatio="xMidYMid meet"/></svg>`;
