...
public class FloatingBubbleService extends Service {
    ...
    private String claudeCodeHtml() {
        return "<html><head><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><style>html,body{margin:0;background:transparent;overflow:hidden;width:100%;height:100%}#a{width:100%;height:100%;display:grid;place-items:center}#idle,#tap,#long,#drag{width:90%;height:90%;border-radius:12px;display:grid;place-items:center;font:700 10px sans-serif;color:#fff}#tap,#long,#drag{display:none}#idle{background:#DE886D;animation:breathe 1.6s infinite ease-in-out}#tap{background:#FFD400;color:#111;animation:bounce 0.6s infinite ease-in-out}#long{background:#90A4AE;animation:float 2s infinite ease-in-out}#drag{background:#A7E0FF;color:#111;animation:bob 0.5s infinite linear}@keyframes breathe{0%,100%{transform:scale(1)}50%{transform:scale(1.06)}}@keyframes bounce{0%,100%{transform:translateY(0)}50%{transform:translateY(-6px) scale(1.05)}}@keyframes float{0%,100%{transform:translateY(0)}50%{transform:translateY(-4px)}}@keyframes bob{0%,100%{transform:translate(0,1px)}25%{transform:translate(-1px,0)}50%{transform:translate(0,-1px)}75%{transform:translate(1px,0)}}</style></head><body><div id=\"a\"><div id=\"idle\">IDLE</div><div id=\"tap\">TAP</div><div id=\"long\">SLEEP</div><div id=\"drag\">WALK</div></div><script>window.playClaude=function(n,ms){var d={tap:1600,long:2000,drag:600,open:1600};if(ms==null)ms=d[n]||1600;var ids=[\"idle\",\"tap\",\"long\",\"drag\"];for(var i=0;i<ids.length;i++){var e=document.getElementById(ids[i]);if(e)e.style.display=\"none\";}var t=document.getElementById(n)||document.getElementById(\"idle\");if(t)t.style.display=\"grid\";clearTimeout(window._pcT);if(n!==\"idle\"&&ms>0)window._pcT=setTimeout(function(){window.playClaude(\"idle\",0)},ms);}</script></body></html>";
    }
